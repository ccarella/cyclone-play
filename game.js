(() => {
  ...
  function readQaAssist() {
    ...
    for (const src of sources) {
      try {
        ...
        if (qaParamOn(new URLSearchParams(q).get("qa"))) return true;
      } catch {
        /* ignore bad query */
      }
    }
  ...
  function updatePlay(dt) {
    ...
    const stormDt = state.stutterT > 0 ? dt * STUTTER_SCALE : dt;
    state.t += stormDt;
